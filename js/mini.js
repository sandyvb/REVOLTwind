$(document).ready(function() {
  ...
  $("#contentarea").load("./modules/products/mini/details.html", (res, status, xhr) => {
    if (status == "success") {
  ...
  $(".specsbtn").on("click", function() {
    $("#contentarea").load("./modules/products/mini/specs.html", (res, status, xhr) => {
      if (status == "success") {
  ...
  $(".gallerybtn").on("click", function() {
    $("#contentarea").load("./modules/products/mini/gallery.html", (res, status, xhr) => {
      if (status == "success") {
        $(".detailsbtn").prop("disabled", false);
        $(".specsbtn").prop("disabled", false);

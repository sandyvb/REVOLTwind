$(document).ready(function () {
  ...
  $('#contentarea').load(
    './modules/products/RW-X/details.html',
    (res, status, xhr) => {
      if (status == 'success') {
  ...
  $('.specsbtn').on('click', function () {
    $('#contentarea').load(
      './modules/products/RW-X/specs.html',
      (res, status, xhr) => {
        if (status == 'success') {
  ...
  $('.gallerybtn').on('click', function () {
    $('#contentarea').load(
      './modules/products/RW-X/gallery.html',
      (res, status, xhr) => {
        if (status == 'success') {
          $('.detailsbtn').prop('disabled', false)
          $('.specsbtn').prop('disabled', false)
  ...
  $('.comparebtn').on('click', function () {
    $('#contentarea').load(
      './modules/products/RW-1/compare.html',
      (res, status, xhr) => {
        if (status == 'success') {
          $('.detailsbtn').prop('disabled', false)
          $('.specsbtn').prop('disabled', false)
  ...
  $('.notesbtn').on('click', function () {
    $('#contentarea').load(
      './modules/products/RW-1/notes.html',
      (res, status, xhr) => {
        if (status == 'success') {
          $('.detailsbtn').prop('disabled', false)
          $('.specsbtn').prop('disabled', false)

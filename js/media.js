...
var videos = [
  ...
  {
    id: 2,
    source: 'videos/RW-X-gusty.mp4',
    thumb: '../videos/RW-X-gusty.jpg',
    caption: 'RW-X Gusty Ground Level',
  },
  {
    id: 3,
  ...
  {
    id: 5,
    source: '/videos/RW-X-spotty.mp4',
    thumb: '/videos/RW-X-spotty.jpg',
    caption: 'RW-X Spotty Winds Ground Level',
  },
  {
    id: 6,
...
function loadThumbnails() {
  for (var i = 0; i < videos.length; i++) {
    document.getElementById('thumbnails').innerHTML +=
      '<figure><img src="' +
      videos[i].thumb +
      '" class="hover-shadow cursor captionText" alt="' +
      videos[i].caption +
      '" onclick="openModal();currentSlide(' +
      i +
      ')" /><figcaption onclick="openModal();currentSlide(' +
      i +
      ')">' +
      videos[i].caption +
      '</figcaption></figure>'
...
function currentSlide(n) {
  ...
  document.getElementById('modalContent').innerHTML =
    ...
    ' / ' +
    videos.length +
    '</div><button class="closebtn" onclick="closeModal()">close</button><video id="currentVideo" poster="' +
    videos[n].thumb +
    '" src="' +
    videos[n].source +
    '" controls></video>'
...
function loadDemoContainer() {
  ...
  for (var i = 0; i < videos.length; i++) {
    document.getElementById('demoContainer').innerHTML +=
      '<img class="demo" src="' +
      videos[i].thumb +
      '" onclick="videoPause();currentSlide(' +
      i +
      ')">'
  }
}
...
function PloadThumbnails() {
  for (var i = 0; i < photos.length; i++) {
    document.getElementById('Pthumbnails').innerHTML +=
      '<img src="' +
      photos[i].thumb +
      '" class="hover-shadow cursor" onclick="PopenModal();PcurrentSlide(' +
      i +
      ')" />'
  }
}
...
function PcurrentSlide(n) {
  ...
  document.getElementById('PmodalContent').innerHTML =
    ...
    ' / ' +
    photos.length +
    '</div><button class="closebtn" onclick="PcloseModal()">close</button><img id="currentVideo" src="' +
    photos[n].source +
    '" />'

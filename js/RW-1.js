$(document).ready(function() {
  ...
  $("#contentarea").load("./modules/products/RW-1/details.html", (res, status, xhr) => {
    if (status == "success") {
  ...
  $(".specsbtn").on("click", function() {
    $("#contentarea").load("./modules/products/RW-1/specs.html", (res, status, xhr) => {
      if (status == "success") {
  ...
  $(".gallerybtn").on("click", function() {
    $("#contentarea").load("./modules/products/RW-1/gallery.html", (res, status, xhr) => {
      if (status == "success") {
        $(".detailsbtn").prop("disabled", false);
        $(".specsbtn").prop("disabled", false);
